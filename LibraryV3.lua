local library = {}
_G.Color = Color3.fromRGB(230, 11, 62) 
_G.imageLogo = "rbxassetid://12940626152"
_G.Logo = "rbxassetid://12940626152"
_G.NameHub = "Made By Kiddo"
_G.Title = "Hiru Hub Script Blox Fruits"
...
UICorner.Parent = ImageButton
	...
	function tabs:Tab(Name, icon)
		...
		FrameTab.Parent = Tab
		FrameTab.BackgroundColor3 = Color3.fromRGB(13, 13, 13)
		...
		function sections:Section(Name,side)
			...
			function functionitem:Button(Title, default, callback)
				...
				Button_2.BackgroundColor3 = Color3.fromRGB(230, 11, 62)
				...
				if default then
					TweenService:Create(
						...
						{
							BackgroundColor3 = state and _G.Color or Color3.fromRGB(230, 11, 62)
						}
					):Play()
					callback(default)
					Tgs = default
				...
				function b3Func:Update(state)
					TweenService:Create(
						...
						TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{
							BackgroundColor3 = state and Color3.fromRGB(230, 11, 62) or _G.Color
						}
					):Play()
					callback(state)
					Tgs = state
	   ...
	   Sep2.TextXAlignment = Enum.TextXAlignment.Center
		...
		function functionitem:Button(Name, callback)
			...
			function functionitem:Dropdown(Name, list, default, callback)
				...
				Scroll_Items.CanvasSize = UDim2.new(2, 0, 0, 0)
  ...
  function functionitem:Slider(text, floor, min, max, de, callback)
    ...
    PartValue.BackgroundTransparency = 1.0
    ...
    MainValue.BackgroundTransparency = 0.9
